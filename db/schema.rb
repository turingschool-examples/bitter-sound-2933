...
ActiveRecord::Schema.define(version: 2022_05_24_194008) do
  ...
  create_table "contestants", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "project_id"
    t.index ["project_id"], name: "index_contestants_on_project_id"
  end
