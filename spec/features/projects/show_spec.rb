...
RSpec.describe Project, type: :feature do
  ...
  it 'will see the number of contestants on the project' do
    ...
    it 'will see the average number of years experience for contestants on the project' do
    jay = Contestant.create(name: "Jay McCarroll", age: 40, hometown: "LA", years_of_experience: 20)
    ...
    visit "/projects/#{news_chic.id}"
      ...
      expect(page).to have_content('Contestants Average Years Experience: 15')
    end
  end
end